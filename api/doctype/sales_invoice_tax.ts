...
export const documentType = (() => {
    const type: MyERPDocType = {
        ...
        fields: [
            ...
            {
                id: 'taxId', type: 'link', options: "selling_tax", showInTable: true, showInForm: true,
            ...
            { id: 'rate', type: 'currency', defaultValue: 0, mandatory: true, label: '{"en":"Charge Rate"}', showInTable: true, showInForm: true, sectionId: 'sectionDetails', callClientScript: true },
