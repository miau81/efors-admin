...
export const documentType = (() => {
    const type: MyERPDocType = {
        ...
        sections: [
            ...
            { id: 'sectionBusinessInfo', label: '{"en":"Business Info"}', sorting: 1, parent: 'tabDetails' },
        ...
        fields: [
            ...
            { id: 'tinNo', type: 'text', label: '{"en":"Tin No"}', showInTable: true, showInForm: true, sectionId: 'sectionBusinessInfo' },
            { id: 'businessRegNo', type: 'text', label: '{"en":"Business Registration No"}', showInTable: true, showInForm: true, sectionId: 'sectionBusinessInfo' },
            { id: 'businessActivity', type: 'text', label: '{"en":"Business Activity Description"}', showInTable: false, showInForm: true, sectionId: 'sectionBusinessInfo' },
            {
                id: 'identificationType', type: 'link', options: "einvoice_id_type", showInForm: true,
                linkOptions: { valueField: "id", labelField: "id,name" },
                label: '{"en":"Identification Type"}', sectionId: 'sectionBusinessInfo'
            },
            { id: 'sstRegistration', type: 'text', label: '{"en":"SST Registration No"}', showInForm: true, sectionId: 'sectionBusinessInfo' },
            {
